...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
	...
	// NOTE: As suggested in the lesson multiple each component of 
	// cost function with an appropriate value.
    ...
    for (unsigned int t = 0; t < N - 2; t++) {
      ...
      fg[0] += 1500*CppAD::pow(vars[a_start + t + 1] - vars[a_start + t], 2);
    }
